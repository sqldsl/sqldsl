# SQLDSL is a SQL domain specific language

SQLDSL fork from [jOOQ](https://www.jooq.org) 3.1.0 edition.

## SQLDSL's reason for being - compared to JPA
